...
@Component({
  selector: 'app-carousel-customers',
  templateUrl: './carousel-customers.component.html',
  styleUrls: ['./carousel-customers.component.scss']
})
export class CarouselCustomersComponent {
