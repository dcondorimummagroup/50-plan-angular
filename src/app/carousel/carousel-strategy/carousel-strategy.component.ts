...
@Component({
  selector: 'app-carousel-strategy',
  templateUrl: './carousel-strategy.component.html',
  styleUrls: ['./carousel-strategy.component.scss']
})
export class CarouselStrategyComponent {
