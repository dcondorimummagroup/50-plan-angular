...
@Component({
  selector: 'app-simulator-mobile-investor',
  templateUrl: './simulator-mobile-investor.component.html',
  styleUrls: ['./simulator-mobile-investor.component.scss']
})
export class SimulatorMobileInvestorComponent {
