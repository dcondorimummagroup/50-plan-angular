...
@Component({
  selector: 'app-orbit-card-promoter-3',
  templateUrl: './orbit-card-promoter-3.component.html',
  styleUrls: ['./orbit-card-promoter-3.component.scss']
})
export class OrbitCardPromoter3Component implements OnInit {
  ...
  constructor(private orbitService: Orbit3PromoterService) {}
  ...
  applyInvestments(): void {
    if (this.users.length < 3) {
      ...
      this.errorMessage = `Se requieren 3 usuarios. Actualmente hay ${this.users.length}`;
      return;
    }
