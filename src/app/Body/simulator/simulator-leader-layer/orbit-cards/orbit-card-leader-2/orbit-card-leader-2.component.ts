...
@Component({
  selector: 'app-orbit-card-leader-2',
  templateUrl: './orbit-card-leader-2.component.html',
  styleUrls: ['./orbit-card-leader-2.component.scss']
})
export class OrbitCardLeader2Component implements OnInit {
