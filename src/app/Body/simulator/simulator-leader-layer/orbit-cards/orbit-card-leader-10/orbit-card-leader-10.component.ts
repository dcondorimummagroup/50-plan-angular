...
@Component({
  selector: 'app-orbit-card-leader-10',
  templateUrl: './orbit-card-leader-10.component.html',
  styleUrls: ['./orbit-card-leader-10.component.scss']
})
export class OrbitCardLeader10Component {
