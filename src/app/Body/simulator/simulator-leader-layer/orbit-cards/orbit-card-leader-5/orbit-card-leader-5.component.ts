...
@Component({
  selector: 'app-orbit-card-leader-5',
  templateUrl: './orbit-card-leader-5.component.html',
  styleUrls: ['./orbit-card-leader-5.component.scss']
})
export class OrbitCardLeader5Component {
