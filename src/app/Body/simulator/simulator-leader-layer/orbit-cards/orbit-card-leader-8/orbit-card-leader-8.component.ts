...
@Component({
  selector: 'app-orbit-card-leader-8',
  templateUrl: './orbit-card-leader-8.component.html',
  styleUrls: ['./orbit-card-leader-8.component.scss']
})
export class OrbitCardLeader8Component {
