...
@Component({
  selector: 'app-orbit-card-leader-9',
  templateUrl: './orbit-card-leader-9.component.html',
  styleUrls: ['./orbit-card-leader-9.component.scss']
})
export class OrbitCardLeader9Component {
