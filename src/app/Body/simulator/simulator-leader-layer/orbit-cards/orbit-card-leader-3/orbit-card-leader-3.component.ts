...
@Component({
  selector: 'app-orbit-card-leader-3',
  templateUrl: './orbit-card-leader-3.component.html',
  styleUrls: ['./orbit-card-leader-3.component.scss']
})
export class OrbitCardLeader3Component {
  ...
  constructor(private othersOrbitService: Orbit3Service) {}
  ...
  applyInvestments(): void {
    ...
    console.log('Total de Órbita 3 enviado:', this.totalInvestment);
    console.log('Usuarios Órbita 3 guardados:', this.users);
  ...
  private calculateTotalInvestment(): void {
    ...
    console.log('Inversiones Órbita 3:', this.users.map(u => ({
      nombre: u.name,
      monto: u.investment
    })));
    console.log('Total calculado Órbita 3:', this.totalInvestment);
  }
